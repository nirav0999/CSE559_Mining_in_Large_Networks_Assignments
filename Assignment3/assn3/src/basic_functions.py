...
def sortDictionary(dictionary,attribute = "k",reverse = True):
	od = {}
	if attribute == "k":
		print("Ordering by key.....")
		od = collections.OrderedDict(sorted(dictionary.items(), key=lambda t: t[0],reverse = reverse))  
	elif attribute == "v":
		print("Ordering by Value.....")
		od = collections.OrderedDict(sorted(dictionary.items(), key=lambda t: t[1],reverse  = reverse))
	else:
